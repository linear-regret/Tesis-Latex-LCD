...
% \end{itemize}
% IR2(A)  IR2(B) en caso de que A  B, (2) simultaneamente evalua todos los aspectos
% deseables de una aproximacion al frente de Pareto, (3) las soluciones que genera
% estan usualmente uniformemente distribuidas, y (4) es mucho menos costoso computacionalmente
% que HV.
